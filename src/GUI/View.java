...
public class View extends JFrame {
    ...
    private void condividiToDo(ToDo todo) {
        String userEmail = JOptionPane.showInputDialog(this, "Inserisci l'email dell'utente con cui condividere il ToDo:", "Condividi ToDo", JOptionPane.PLAIN_MESSAGE);
        if (userEmail != null && !userEmail.trim().isEmpty()) {
            controller.condividiToDo(todo, userEmail.trim());
        }
    }
